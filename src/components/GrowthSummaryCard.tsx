...
export default function GrowthSummaryCard({ trialCount, newBizCount, activationRate }: Props) {
  return (
    <div className="bg-[#EEEAFE] rounded-xl p-6 flex flex-wrap items-center justify-between gap-4">
      <div className="flex items-center gap-3 flex-shrink-0">
        ...
        <div>
          <p className="text-sm font-extrabold text-[#1F2430]">{t.growth.summaryCard.title}</p>
          <p className="text-[10px] text-[#6B7280]">MRR · Trial · Aktivasyon</p>
        </div>
      </div>
