    ...
    <main className="pt-24 pb-12 px-4 md:px-8 min-h-screen bg-[var(--bg-page)]">
      ...
      <div className="mb-8 flex justify-between items-end">
        <div>
          ...
          <p className="text-[var(--text-2)] text-sm font-medium">{t.settings.subtitle}</p>
        </div>
        <button
          onClick={handleSave}
          disabled={saving}
        ...
        <div className="col-span-12 lg:col-span-5 flex flex-col gap-6">
                ...
                <div key={item.key} className="flex items-start justify-between gap-4">
                  ...
                  <button
                    ...
                    className={`relative inline-flex h-6 w-11 flex-shrink-0 rounded-full transition-colors duration-200 ${
                      settings.notifications[item.key] ? "bg-[#7C6CF6]" : "bg-[var(--border)]"
                    }`}
                  >
                    <span
          ...
          <section className="bg-[var(--accent-bg)] rounded-xl p-8 border border-[#D4CFFE]">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-sm font-bold text-[var(--text-1)] mb-1">Platform Operatör Paneli</p>
            ...
            <div className="mt-4 pt-4 border-t border-[#D4CFFE] flex items-center gap-2">
              ...
              <span className="text-xs font-semibold text-[#7C6CF6]">
